...
class Register extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('/api/user/register', newUser).then(res => console.log(res.data)).catch(err => console.log(err.response.data));
    }
        ...
        return (
            <div className="register">
                ...
                <div className="row">
                    ...
                    <p className="lead text-center">Create your InstaPlus account</p>
